...
data IntoSysML_ASD_MM_Es = ASD_MM_ENamed_name | ASD_MM_EPInterval_lb | ASD_MM_EPInterval_ub | ASD_MM_EHasBlocks | ASD_MM_EHasVTypes | ASD_MM_EHasCompositions 
   | ASD_MM_EVariable_kind | ASD_MM_EProperty_type | ASD_MM_EProperty_init | ASD_MM_EOutFlowPort_depends | ASD_MM_EDType_base | ASD_MM_EUnitType_unit 
   | ASD_MM_EHasLiterals | ASD_MM_EStrtType_fields | ASD_MM_EBlock_fports | ASD_MM_EComponent_vars | ASD_MM_EComponent_kind | ASD_MM_ECompound_phenomena 
   | ASD_MM_EComposition_src | ASD_MM_EComposition_tgt | ASD_MM_EComposition_srcM | ASD_MM_EComposition_tgtM | ASD_MM_EMultRange_lb | ASD_MM_EMultValNum_n 
   | ASD_MM_EMultSingle_val | ASD_MM_EMultRange_ub | ASD_MM_EHasSystem | ASD_MM_EComposition_tgt_sys | ASD_MM_EComposition_src_elem
   deriving (Read, Show, Eq)
