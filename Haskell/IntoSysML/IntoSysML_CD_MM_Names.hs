...
data IntoSysML_CD_MM_Es = CD_MM_Ename | CD_MM_Eports | CD_MM_EConnector_src | CD_MM_EConnector_tgt | CD_MM_ECompositionI_tgt | CD_MM_ECompositionI_src | CD_MM_EConnector_ftype | CD_MM_EHasElements
    deriving (Read, Show, Eq)
