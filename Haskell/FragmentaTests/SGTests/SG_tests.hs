...
do_test2 = do
   ...
   check_morphism (nm_m1 ++ ": " ++ nm2 ++ "->" ++ nm1 ++ " (Weak, morphism)") (Just WeakM) sg2 m1 sg1 True
   check_morphism (nm_m2 ++ ": " ++ nm3 ++ "->" ++ nm1 ++ " (Weak, morphism)") (Just WeakM) sg3 m2 sg1 True
   check_morphism ("Union of morphisms: " ++ nm3 ++ " U " ++ nm2 ++ "->" ++ nm1 ++ " (Weak, morphism)") (Just WeakM) (sg2 `union_sg` sg3) (m1 `union_gm` m2) sg1 True
   ...
   check_morphism ("Union of morphisms: " ++ nm2 ++ " U " ++ nm3 ++ "->" ++ nm1 ++ " (Total, morphism)") (Just TotalM) (sg3 `union_sg` sg2) (m1 `union_gm` m2) sg1 True
