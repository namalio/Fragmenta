...
check_multOk me r s t m1 m2@(Sm (Val 0)) = if (multOk r s t m1 m2) then nile else cons_et (mult_err_msg me m1 m2) []
check_multOk me r s t m1@(Sm (Val 0)) m2 = if (multOk r s t m1 m2) then nile else cons_et (mult_err_msg me m1 m2) []
