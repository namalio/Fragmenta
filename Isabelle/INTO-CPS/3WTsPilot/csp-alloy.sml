structure CSP_Alloy : sig
  ...
  val mdlTy_3WTsP_loop : unit mdlTy_ls_ext
end = struct
...
val sG_CD_3WTsP_loop : unit sGr_ls_ext gr_ls_ext =
  Gr_ls_ext
    ([[#"P", #"r", #"T", #"a", #"n", #"k", #"I", #"O"],
       [#"P", #"r", #"T", #"a", #"n", #"k", #"I", #"O", #"V"],
       [#"P", #"r", #"I", #"n", #"f", #"l", #"o", #"w"],
      ...
      SGr_ls_ext
        ([([#"P", #"r", #"T", #"a", #"n", #"k", #"I", #"O"], Nprxy),
           ...
           ([#"p", #"o", #"u", #"t"], Nnrml), ([#"t", #"2", #"i", #"n"], Nnrml),
           ([#"t", #"2", #"o", #"u", #"t"], Nnrml),
           ([#"w", #"i", #"n", #"1"], Nnrml), ([#"w", #"o", #"u", #"t"], Nnrml),
           ([#"w", #"i", #"n"], Nnrml), ([#"w", #"l", #"o", #"u", #"t"], Nnrml),
           ([#"v", #"i", #"1"], Nnrml), ([#"t", #"3", #"i", #"n"], Nnrml),
           ([#"t", #"3", #"w", #"l", #"o", #"u", #"t"], Nnrml),
           ([#"t", #"3", #"o", #"u", #"t"], Nnrml), ([#"v", #"i", #"2"], Nnrml),
           ([#"d", #"i", #"n"], Nnrml), ([#"d", #"o", #"u", #"t"], Nnrml),
           ([#"w", #"l", #"i", #"n"], Nnrml), ([#"v", #"o"], Nnrml),
           ([#"C", #"_", #"w", #"i", #"n", #"1", #"_", #"t", #"1", #"i", #"n"],
             Nnrml),
           ([#"C", #"_", #"i", #"o", #"u", #"t", #"_", #"t", #"1", #"i", #"n"],
...
val f_CD_3WTsP_loop : unit fr_ls_ext =
  Fr_ls_ext
    (sG_CD_3WTsP_loop,
      [([#"E", #"R", #"P", #"r", #"T", #"a", #"n", #"k", #"I", #"O"],
         [#"T", #"a", #"n", #"k", #"I", #"O"]),
...
val gFG_3WTsP_loop : unit gFGr_ls_ext gr_ls_ext =
  Gr_ls_ext
    ([[#"F", #"_", #"A", #"S", #"D", #"_", #"3", #"W", #"T", #"s", #"P", #"_",
        #"l", #"o", #"o", #"p"],
       [#"F", #"_", #"C", #"D", #"_", #"3", #"W", #"T", #"s", #"P", #"_", #"l",
         #"o", #"o", #"p"]],
      [[#"E", #"_", #"F", #"_", #"C", #"D", #"_", #"3", #"W", #"T", #"s", #"P",
         #"_", #"l", #"o", #"o", #"p", #"_", #"A", #"S", #"D"],
        [#"E", #"_", #"F", #"_", #"A", #"S", #"D", #"_", #"3", #"W", #"T", #"s",
...
val sG_ASD_3WTsP_loop : unit sGr_ls_ext gr_ls_ext =
  Gr_ls_ext
    ([[#"3", #"W", #"a", #"t", #"e", #"r", #"T", #"a", #"n", #"k", #"s", #"A",
        #"S", #"D"],
       [#"3", #"W", #"a", #"t", #"e", #"r", #"T", #"a", #"n", #"k", #"s", #"S",
...
val f_ASD_3WTsP_loop : unit fr_ls_ext = Fr_ls_ext (sG_ASD_3WTsP_loop, [], ());

val mdl_3WTsP_loop : unit mdl_ls_ext =
  Mdl_ls_ext
    (gFG_3WTsP_loop,
      [([#"F", #"_", #"A", #"S", #"D", #"_", #"3", #"W", #"T", #"s", #"P", #"_",
          #"l", #"o", #"o", #"p"],
...
val t_F_CD_3WTsP_loop : unit morphL_ext =
  MorphL_ext
    ([([#"P", #"r", #"T", #"a", #"n", #"k", #"I", #"O"],
        [#"P", #"r", #"B", #"l", #"o", #"c", #"k", #"3"]),
       ([#"P", #"r", #"T", #"a", #"n", #"k", #"I", #"O", #"V"],
...
val t_F_ASD_3WTsP_loop : unit morphL_ext =
  MorphL_ext
    ([([#"3", #"W", #"a", #"t", #"e", #"r", #"T", #"a", #"n", #"k", #"s", #"A",
         #"S", #"D"],
        [#"A", #"S", #"D"]),
...
val mdlTy_3WTsP_loop : unit mdlTy_ls_ext =
  MdlTy_ls_ext
    (iNTO_SysML_MM_T, mdl_3WTsP_loop,
      consUGM t_F_ASD_3WTsP_loop t_F_CD_3WTsP_loop, ());
