...
definition T_F_ASD_3WTs :: "Morph"
where
   "T_F_ASD_3WTs \<equiv> \<lparr>fV = [''WaterTanksASD''\<mapsto>''ASD'', ''WaterTanksSys''\<mapsto>''System'', 
   ''CompWaterTanksSys1''\<mapsto>''Composition'',
    ''CompWaterTanksSys2''\<mapsto>''Composition'', ''CompWaterTanksSys3''\<mapsto>''Composition'',
    ''TanksControl1''\<mapsto>''EComponent'', ''TanksControl2''\<mapsto>''EComponent'', 
    ''CompTanksControl1Valve''\<mapsto>''Composition'',
    ''CompTanksControl1WaterTank''\<mapsto>''Composition'', 
    ''CompTanksControl2WaterTank''\<mapsto>''Composition'',
    ''Controller''\<mapsto>''EComponent'',
    ''Valve''\<mapsto>''POComponent'', ''WaterTank''\<mapsto>''POComponent'', 
    ''FlowRate''\<mapsto>''DType'', ''Area''\<mapsto>''DType'', 
    ''Height''\<mapsto>''DType'', ''OpenClosed''\<mapsto>''Enumeration'',
    ''WaterTank_win''\<mapsto>''FlowPort'', ''WaterTank_wout''\<mapsto>''FlowPort'', 
    ''Valve_v2''\<mapsto>''FlowPort'', ''Valve_w''\<mapsto>''FlowPort'', 
    ''Controller_v1''\<mapsto>''FlowPort''], 
    fE = [
      ''EWaterTanksASD_WaterTanksSys''\<mapsto>''Eblocks'', 
      ''EWaterTanksASD_TanksControl1''\<mapsto>''Eblocks'', 
      ''EWaterTanksASD_TanksControl2''\<mapsto>''Eblocks'', 
      ''EWaterTanksASD_Valve''\<mapsto>''Eblocks'', 
      ''EWaterTanksASD_WaterTank''\<mapsto>''Eblocks'', 
      ''EWaterTanksASD_FlowRate''\<mapsto>''Etypes'', 
      ''EWaterTanksASD_Area''\<mapsto>''Etypes'', 
      ''EWaterTanksASD_Height''\<mapsto>''Etypes'', 
      ''EWaterTanksASD_OpenClosed''\<mapsto>''Etypes'',
      ''ECompWaterTanksSys1_src''\<mapsto>''Esrc'',
      ''ECompWaterTanksSys2_src''\<mapsto>''Esrc'',
      ''ECompWaterTanksSys3_src''\<mapsto>''Esrc'',
      ''ECompWaterTanksSys1_tgt''\<mapsto>''Etgt'',
      ''ECompWaterTanksSys2_tgt''\<mapsto>''Etgt'',
      ''ECompWaterTanksSys3_tgt''\<mapsto>''Etgt'',
      ''ECompTanksControl1Valve_src''\<mapsto>''Esrc'',
      ''ECompTanksControl1WaterTank_src''\<mapsto>''Esrc'', 
      ''ECompTanksControl2WaterTank_src''\<mapsto>''Esrc'',
      ''ECompTanksControl1Valve_tgt''\<mapsto>''Etgt'',
      ''ECompTanksControl1WaterTank_tgt''\<mapsto>''Etgt'', 
      ''ECompTanksControl2WaterTank_tgt''\<mapsto>''Etgt'',
      ''E_WaterTank_win''\<mapsto>''EBlockProps'', 
      ''E_WaterTank_out''\<mapsto>''EBlockProps'', 
      ''E_Valve_v2''\<mapsto>''EBlockProps'', 
      ''E_Valve_w''\<mapsto>''EBlockProps'', 
      ''E_Controller_v1''\<mapsto>''EBlockProps'',
      ''E_Dep_w_v2''\<mapsto>''EFlowPortDepends'', 
      ''E_Dep_wout_win''\<mapsto>''EFlowPortDepends'']\<rparr>"

(*Define the other morphism*)
definition T_F_CD_3WTs :: "Morph"
where
   "T_F_CD_3WTs \<equiv> \<lparr>fV = [''PrWaterTank''\<mapsto>''PrBlock3'', 
      ''PrValve''\<mapsto>''PrBlock3'', 
      ''PrTanksControl1''\<mapsto>''PrBlock3'', 
      ''PrTanksControl2''\<mapsto>''PrBlock3'', 
      ''PrController''\<mapsto>''PrBlock3'', 
      ''CD_3WTs''\<mapsto>''ConnectionsDiagram'', 
      ''WTSys''\<mapsto>''BlockInstance'', 
      ''V''\<mapsto>''BlockInstance'', 
      ''WT1''\<mapsto>''BlockInstance'', 
      ''WT2''\<mapsto>''BlockInstance'', 
      ''WT3''\<mapsto>''BlockInstance'', 
      ''C''\<mapsto>''BlockInstance'',
      ''TC1''\<mapsto>''BlockInstance'', 
      ''TC2''\<mapsto>''BlockInstance'', 
      ''C_w_win1''\<mapsto>''Connector'', 
      ''C_wout1_win2''\<mapsto>''Connector'', 
      ''C_wout2_win3''\<mapsto>''Connector'',
      ''C_v1_v2''\<mapsto>''Connector'',
      ''v1''\<mapsto>''Port'', ''v2''\<mapsto>''Port'', ''w''\<mapsto>''Port'', ''win1''\<mapsto>''Port'', 
      ''wout1''\<mapsto>''Port'', ''win2''\<mapsto>''Port'', ''wout2''\<mapsto>''Port'',
      ''win3''\<mapsto>''Port'', ''wout3''\<mapsto>''Port'', 
      ''PrValve_v2''\<mapsto>''PrFlowPort2'', ''PrValve_w''\<mapsto>''PrFlowPort2'', 
      ''PrWaterTank_win''\<mapsto>''PrFlowPort2'', 
      ''PrWaterTank_wout''\<mapsto>''PrFlowPort2'', ''PrController_v1''\<mapsto>''PrFlowPort2''],
    fE = [''ECD_WTSys''\<mapsto>''ECDblocks'', ''ECD_V''\<mapsto>''ECDblocks'', 
      ''ECD_WT1''\<mapsto>''ECDblocks'', ''ECD_WT2''\<mapsto>''ECDblocks'',
      ''ECD_WT3''\<mapsto>''ECDblocks'', ''ECD_C''\<mapsto>''ECDblocks'',
      ''ECD_TC1''\<mapsto>''ECDblocks'', ''ECD_TC2''\<mapsto>''ECDblocks'',
      ''ECD_C_v1_v2''\<mapsto>''ECDconnectors'', ''ECD_C_w_win1''\<mapsto>''ECDconnectors'',
      ''ECD_C_wout1_win2''\<mapsto>''ECDconnectors'', 
      ''ECD_C_wout2_win3''\<mapsto>''ECDconnectors'',
      ''E_C_v1_v2_src''\<mapsto>''EC_src'', ''E_C_v1_v2_tgt''\<mapsto>''EC_tgt'', 
      ''E_C_w_win1_src''\<mapsto>''EC_src'', ''E_C_w_win1_tgt''\<mapsto>''EC_tgt'', 
      ''E_C_wout1_win2_src''\<mapsto>''EC_src'', ''E_C_wout1_win2_tgt''\<mapsto>''EC_tgt'', 
      ''E_C_wout2_win3_src''\<mapsto>''EC_src'', ''E_C_wout2_win3_tgt''\<mapsto>''EC_tgt'', 
      ''E_C_v1''\<mapsto>''EBIports'', ''E_V_v2''\<mapsto>''EBIports'', ''E_V_w''\<mapsto>''EBIports'', 
      ''E_WT1_win1''\<mapsto>''EBIports'',
      ''E_WT1_wout1''\<mapsto>''EBIports'', ''E_WT2_win2''\<mapsto>''EBIports'',
      ''E_WT2_wout2''\<mapsto>''EBIports'', ''E_WT3_win3''\<mapsto>''EBIports'', 
      ''E_WT3_wout3''\<mapsto>''EBIports'', ''E_v1_ty''\<mapsto>''EPortType'', 
      ''E_v2_ty''\<mapsto>''EPortType'', ''E_w_ty''\<mapsto>''EPortType'',
      ''E_win1_ty''\<mapsto>''EPortType'', 
      ''E_wout1_ty''\<mapsto>''EPortType'',
      ''E_win2_ty''\<mapsto>''EPortType'', ''E_wout2_ty''\<mapsto>''EPortType'', 
      ''E_win3_ty''\<mapsto>''EPortType'', ''E_wout3_ty''\<mapsto>''EPortType'',
      ''ERPrWaterTank''\<mapsto>''ERPrBlock3'', ''ERPrValve''\<mapsto>''ERPrBlock3'', 
      ''ERPrTanksControl1''\<mapsto>''ERPrBlock3'', 
      ''ERPrTanksControl2''\<mapsto>''ERPrBlock3'',
      ''ERPrController''\<mapsto>''ERPrBlock3'', 
      ''ERPrValve_v2''\<mapsto>''ERPrFlowPort2'',
      ''ERPrValve_w''\<mapsto>''ERPrFlowPort2'', ''ERPrWaterTank_win''\<mapsto>''ERPrFlowPort2'',
      ''ERPrWaterTank_wout''\<mapsto>''ERPrFlowPort2'', ''ERPrController_v1''\<mapsto>''ERPrFlowPort2'']\<rparr>"
...
where
  "MdlTy_3WTs \<equiv> \<lparr>tmdl_ls = INTO_SysML_MM_T, 
    mdl_ls = Mdl_3WTs,
    mty_ls = (T_F_ASD_3WTs UGM T_F_CD_3WTs)\<rparr>"
...
value "consUMdlFs (mdl_ls MdlTy_3WTs)"
 
value "INTO_SysML_toPDG_Nodes (mdl_ls MdlTy_3WTs) (mty_ls MdlTy_3WTs)"

value "INTO_SysML_toPDG (mdl_ls MdlTy_3WTs) (mty_ls MdlTy_3WTs)"
...
value "portNodes (mdl_ls MdlTy_3WTs) (mty_ls MdlTy_3WTs)"

value "edgesOfTy (mdl_ls MdlTy_3WTs) (mty_ls MdlTy_3WTs) ''EPortType''"

value "edgesOfTy (mdl_ls MdlTy_3WTs) (mty_ls MdlTy_3WTs) ''EFlowPortDepends''"

value "edgesOfTy (mdl_ls MdlTy_3WTs) (mty_ls MdlTy_3WTs) ''EBIports''"

value "the (tgt (sg (toFr (consUMdlFs (mdl_ls MdlTy_3WTs)))) ''E_WT3_win3'')"

value "the (tgt (sg (toFr (consUMdlFs (mdl_ls MdlTy_3WTs)))) ''E_v2_ty'')"

value "(set (consSrcStF (consUMdlFs (mdl_ls MdlTy_3WTs)))) ``{''E_Dep_w_v2''}"

value "the (tgt (sg (toFr (consUMdlFs (mdl_ls MdlTy_3WTs)))) ''E_Dep_w_v2'')"

(*Get these functions right*)
value "getBlockInstanceOfPort (mty_ls MdlTy_3WTs) (consUMdlFs (mdl_ls MdlTy_3WTs)) ''win3''"
value "getOtherInternalPorts (mty_ls MdlTy_3WTs) (consUMdlFs (mdl_ls MdlTy_3WTs)) ''win3''"
value "getFlowPortTypeOfPort (mty_ls MdlTy_3WTs) (consUMdlFs (mdl_ls MdlTy_3WTs)) ''win3''"

(*
value "getDependentPortOfV (mty_ls MdlTy_3WTs) (consUMdlFs (mdl_ls MdlTy_3WTs)) ''w'' ''PrValve_v2''"
*)
value "(fV (mty_ls MdlTy_3WTs)) (the (tgt (sg (toFr (consUMdlFs (mdl_ls MdlTy_3WTs)))) ''E_v2_ty''))"

value "(set(consTgtStF (consUMdlFs (mdl_ls MdlTy_3WTs)))) ``{''E_v2_ty''}"

value "consClanF ''PrController_v1'' (consUMdlFs (mdl_ls MdlTy_3WTs))"
...
value "buildGrForConnector (mty_ls MdlTy_3WTs) (consUMdlFs (mdl_ls MdlTy_3WTs)) ''C_w_win1''"
value "dependsGrOf (mdl_ls MdlTy_3WTs) (mty_ls MdlTy_3WTs) ''win3''"
value "internalConnectionsOf (mdl_ls MdlTy_3WTs) (mty_ls MdlTy_3WTs) ''w''"
