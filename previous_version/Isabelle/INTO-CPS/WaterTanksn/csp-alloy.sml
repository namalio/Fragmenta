structure CSP_Alloy : sig
  ...
  and decl = Channel of (char list) list | Eqdecl of exp * exp |
    AssertT of exp * exp | AssertFD of exp * exp
  ...
  datatype assertDecl = Assert of char list * aExp list
  ...
  val esG : 'a gr_ls_ext -> (char list) list
  val src : 'a gr_ext -> char list -> (char list) option
  val nsG : 'a gr_ls_ext -> (char list) list
  val toGr : 'a gr_ls_ext -> unit gr_ext
  val toCSP : unit gr_ls_ext -> cSPSpec
  val tgt : 'a gr_ext -> char list -> (char list) option
  val toAlloy : unit gr_ls_ext -> alloyModule
  val genPDGOfWtsn : nat -> unit gr_ls_ext
  val genPDGOfWtsn_loop : nat -> unit gr_ls_ext
...
fun consTankN n =
  Gr_ls_ext
    ([[#"t"] @ str_nat n @ [#"w", #"i"], [#"t"] @ str_nat n @ [#"w", #"o"]],
      [[#"e", #"_", #"t"] @
         str_nat n @ [#"w", #"i", #"_", #"t"] @ str_nat n @ [#"w", #"o"]],
      [([#"e", #"_", #"t"] @
          str_nat n @ [#"w", #"i", #"_", #"t"] @ str_nat n @ [#"w", #"o"],
         [#"t"] @ str_nat n @ [#"w", #"i"])],
      [([#"e", #"_", #"t"] @
...
fun consLinkMinus1 n =
  (if less_eq_nat n one_nat then emptyGL
    else Gr_ls_ext
           ([], [[#"e", #"_", #"t"] @
                   str_nat (minus_nat n one_nat) @
                     [#"w", #"o", #"_", #"t"] @ str_nat n @ [#"w", #"i"]],
             [([#"e", #"_", #"t"] @
                 str_nat (minus_nat n one_nat) @
                   [#"w", #"o", #"_", #"t"] @ str_nat n @ [#"w", #"i"],
                [#"t"] @ str_nat (minus_nat n one_nat) @ [#"w", #"o"])],
             [([#"e", #"_", #"t"] @
                 str_nat (minus_nat n one_nat) @
                   [#"w", #"o", #"_", #"t"] @ str_nat n @ [#"w", #"i"],
                [#"t"] @ str_nat n @ [#"w", #"i"])],
...
fun consTankNWithLinkToMinus1 n =
  (case n of Zero_nat => emptyGL
    | Suc k =>
      (if equal_nat k Zero_nat then consTankN (Suc k)
        else consUG (consTankN (Suc k)) (consLinkMinus1 (Suc k))));

fun consNConnectedTanks Zero_nat = emptyGL
  | consNConnectedTanks (Suc n) =
    consUG (consTankNWithLinkToMinus1 (Suc n)) (consNConnectedTanks n);

fun g_ConnectorToBase n =
  (if equal_nat n Zero_nat then emptyGL
    else Gr_ls_ext
           ([[#"t"] @ str_nat n @ [#"w", #"l", #"o"],
              [#"t"] @ str_nat n @ [#"v", #"i"]],
             [[#"e", #"_", #"s", #"w", #"_", #"t"] @ str_nat n @ [#"w", #"i"],
               [#"e", #"_", #"t"] @
                 str_nat n @
                   [#"w", #"i", #"_", #"t"] @ str_nat n @ [#"w", #"l", #"o"],
               [#"e", #"_", #"t"] @
                 str_nat n @ [#"w", #"o", #"_", #"d", #"w", #"i"],
               [#"e", #"_", #"t"] @
                 str_nat n @ [#"w", #"l", #"o", #"_", #"c", #"w", #"l", #"i"],
               [#"e", #"_", #"c", #"v", #"o", #"_", #"t"] @
                 str_nat n @ [#"v", #"i"],
               [#"e", #"_", #"t"] @
                 str_nat n @
                   [#"v", #"i", #"_", #"t"] @ str_nat n @ [#"w", #"o"]],
             [([#"e", #"_", #"s", #"w", #"_", #"t"] @ str_nat n @ [#"w", #"i"],
                [#"s", #"w"]),
               ([#"e", #"_", #"t"] @
                  str_nat n @
...
fun connectToBase n = consUG g_BaseWTsn (g_ConnectorToBase n);

fun genPDGOfWtsn n =
  (if equal_nat n Zero_nat then emptyGL
    else consUG (consNConnectedTanks n) (connectToBase n));

val g_DrainToTankOne : unit gr_ls_ext =
  Gr_ls_ext
    ([[#"d", #"w", #"o"]],
      [[#"e", #"_", #"d", #"w", #"i", #"_", #"d", #"w", #"o"],
        [#"e", #"_", #"d", #"w", #"o", #"_", #"t", #"1", #"w", #"i"]],
...
fun connectToBase_loop n = consUG (connectToBase n) g_DrainToTankOne;

fun genPDGOfWtsn_loop n =
  (if equal_nat n Zero_nat then emptyGL
    else consUG (consNConnectedTanks n) (connectToBase_loop n));
