...
(* The PDG used in "Checking SysML for co-simulation" paper*)
definition PDG_WT1 :: "PDGr"
where
   "PDG_WT1 = \<lparr>NsG=[''sw'', ''win'', ''wout'', ''dwi'', ''wl'', ''wlo'',
    ''wli'', ''vo'', ''vi2'', ''vi1''], 
   EsG = [''e_sw_win'', ''e_win_wout'', ''e_wout_dwi'', ''e_wl_wlo'', ''e_wlo_wli'', 
   ''e_wli_vo'', ''e_vo_vi2'', ''e_vi2_vi1'', ''e_vi1_wout''], 
   srcG = [(''e_sw_win'', ''sw''), (''e_win_wout'', ''win''), (''e_wout_dwi'', ''wout''), 
    (''e_wl_wlo'', ''wl''), (''e_wlo_wli'', ''wlo''), (''e_wli_vo'', ''wli''), (''e_vo_vi2'', ''vo''), 
    (''e_vi2_vi1'', ''vi2''), 
    (''e_vi1_wout'', ''vi1'')], 
   tgtG=[(''e_sw_win'', ''win''), (''e_win_wout'', ''wout''), (''e_wout_dwi'', ''dwi''), 
    (''e_wl_wlo'', ''wlo''), (''e_wlo_wli'', ''wli''), (''e_wli_vo'', ''vo''), (''e_vo_vi2'', ''vi2''), 
    (''e_vi2_vi1'', ''vi1''), 
    (''e_vi1_wout'', ''wout'')]\<rparr>"

axiomatization
where
  Es_PDG_WT1_in_V_E: "set (EsG PDG_WT1) \<subseteq> V_E"
  and Ns_PDG_WT1_in_V_V: "set (NsG PDG_WT1) \<subseteq> V_V"

(* Checks that the graph is well-formed"*)
lemma is_wf_PDG_WT1: "is_wf_PDG PDG_WT1"
  using Es_PDG_WT1_in_V_E Ns_PDG_WT1_in_V_V
    by (auto simp add: PDG_WT1_def is_wf_g_def is_wf_PDG_def ftotal_on_def EsId_def toGr_def)
